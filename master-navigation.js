(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = [
      ...
      '.ateaish-master-nav__toggle{display:inline-flex;align-items:center;justify-content:center;width:66px;height:66px;padding:0;border:0;border-radius:999px;background:linear-gradient(135deg,rgba(117,254,78,.18),transparent 40%),rgba(22,22,22,.96);box-shadow:16px 16px 28px rgba(0,0,0,.34);color:var(--master-nav-text);cursor:pointer;font:inherit;backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);transition:transform 160ms ease,box-shadow 160ms ease,background 160ms ease;position:relative;overflow:hidden;flex:0 0 66px;z-index:2;}',
      '.ateaish-master-nav__toggle::before{content:"";position:absolute;inset:0;background:linear-gradient(90deg,rgba(117,254,78,.44),transparent 18%),linear-gradient(0deg,rgba(117,254,78,.3),transparent 14%);opacity:.9;pointer-events:none;border-radius:inherit;}',
      ...
      '.ateaish-master-nav__panel{position:absolute;right:0;top:0;transform:translateX(0);width:100%;height:66px;padding:0 72px 0 14px;display:flex;align-items:center;background:linear-gradient(90deg,rgba(117,254,78,.12),transparent 12%),rgba(28,28,28,.97);border:0;box-shadow:22px 22px 40px rgba(0,0,0,.34);border-radius:999px;opacity:0;visibility:hidden;pointer-events:none;transition:opacity 220ms ease,visibility 220ms ease;overflow:hidden;}',
      '.ateaish-master-nav__panel::before,.ateaish-master-nav__panel::after{content:"";position:absolute;background:rgba(117,254,78,.38);pointer-events:none;}',
      ...
      '.ateaish-master-nav__link:hover,.ateaish-master-nav__link:focus-visible,.ateaish-master-nav__link.is-active{background:rgba(117,254,78,.1);transform:scale(1.24);filter:brightness(1.08);outline:none;}',
  ...
  function buildNavigation() {
    if (!document.body || document.querySelector('[data-ateaish-master-nav]')) {
      return;
    }
